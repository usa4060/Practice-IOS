...
//  DailyDiary
//
//  Created by admin on 2022/01/26.
//
...
extension ViewController : UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {// 지정된 section에 표시할 cell의 개수를 return한다.
        return self.diaryList.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {   // collectionView에 지정된 위치에 표시할 cell을 요청
